...
def main(url: str, query: str, num_docs: int):
    ...
    print("SIMILAR DOCS FROM CLUSTER:")
    for doc in similar_docs:
        print(doc+"\n" + "---" + "\n")
        
    similar_docs_from_all = retrieve_similar_docs(query_embedding, embeddings, num_docs, documents)
    print("\n\nSIMILAR DOCS FROM ALL:")
    for doc in similar_docs_from_all:
        print(doc+"\n" + "---" + "\n")
